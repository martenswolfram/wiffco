...
from twain_wifco.control_policy import ControlPolicy
...
def validate_data_graph(ambient_statistics: Statistics,
    ...
    control_policy.input_interface.validate_shapes(
        external_shapes={
            Ambient: ambient_statistics.output_interface.all_data_type_shapes[Ambient]},
    ...
    plant_model.input_interface.validate_shapes(
        external_shapes={
            Ambient: ambient_statistics.output_interface.all_data_type_shapes[Ambient],
            Control: control_policy.output_interface.all_data_type_shapes[Control]},
        component_name=plant_model.component_name)

    # Input for aggregation
    aggregation.input_interface.validate_shapes(
        external_shapes={
            ModelOutput: plant_model.output_interface.all_data_type_shapes[ModelOutput],
            Ambient: ambient_statistics.output_interface.all_data_type_shapes[Ambient],
            Control: control_policy.output_interface.all_data_type_shapes[Control]},
    ...
    metrics_accumulation.input_interface.validate_shapes(
        external_shapes={
            Aggregated: aggregation.output_interface.all_data_type_shapes[Aggregated]
        },
